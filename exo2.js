...
function animal (animals){
    switch(animal){
        ...
        case "chien":
            ...
            default:
                return "je ne vais pas faire tous les animeaux de la planéte!!!"
    }
}
console.log (animal("chat"))
...
function plusOuMoin(){
    ...
    console.log("plus ou moin", plusOuMoin())
    console.log("plus ou moin", plusOuMoin())
    console.log("plus ou moin", plusOuMoin())
    console.log("plus ou moin", plusOuMoin())
    console.log("plus ou moin", plusOuMoin())
...
function plusOuMoin(chiffre){
    if(isNaN(chiffre)){
        console.error("il y avoir un nombre")
    return
}else if(chiffre < 0){
    ...
    switch(operateur){
        ...
        case"/":
            if(b !== 0){
                ...
                return "erreur : division par zero impossilbe"
            }  
            case "/":
...
function criAnimals(animal){
    ...
    case "chat":
        return"miaou"
        default :
        return"je ne vais pas fair tous les animaux de la planete !!!"
    }
}
consol(criAnimals("rat"))
